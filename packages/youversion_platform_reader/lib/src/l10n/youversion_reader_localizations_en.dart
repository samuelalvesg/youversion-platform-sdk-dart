...
class YouVersionReaderLocalizationsEn extends YouVersionReaderLocalizations {
  YouVersionReaderLocalizationsEn([String locale = 'en']) : super(locale);
  ...
  @override
  String get searchBooksHint => 'Search';
  ...
  @override
  String get changeVersionTooltip => 'Change Bible version';
