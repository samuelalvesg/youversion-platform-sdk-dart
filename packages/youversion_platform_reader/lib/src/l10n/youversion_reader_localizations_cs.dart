...
class YouVersionReaderLocalizationsCs extends YouVersionReaderLocalizations {
  YouVersionReaderLocalizationsCs([String locale = 'cs']) : super(locale);
  ...
  @override
  String get searchBooksHint => 'Hledání';

  @override
  String get introChipLabel => 'Intro';

  @override
  String get previousChapterTooltip => 'Předchozí kapitola';

  @override
  String get nextChapterTooltip => 'Další kapitola';

  @override
  String get decreaseFontSizeTooltip => 'Zmenšit velikost písma';

  @override
  String get increaseFontSizeTooltip => 'Zvětšit velikost písma';
