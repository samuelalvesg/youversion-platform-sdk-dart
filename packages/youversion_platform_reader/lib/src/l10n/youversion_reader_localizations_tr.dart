...
class YouVersionReaderLocalizationsTr extends YouVersionReaderLocalizations {
  YouVersionReaderLocalizationsTr([String locale = 'tr']) : super(locale);
  ...
  @override
  String get searchBooksHint => 'Ara';

  @override
  String get introChipLabel => 'Intro';

  @override
  String get previousChapterTooltip => 'Önceki bölüm';

  @override
  String get nextChapterTooltip => 'Sonraki bölüm';

  @override
  String get decreaseFontSizeTooltip => 'Yazı tipi boyutunu küçült';

  @override
  String get increaseFontSizeTooltip => 'Yazı tipi boyutunu artır';
